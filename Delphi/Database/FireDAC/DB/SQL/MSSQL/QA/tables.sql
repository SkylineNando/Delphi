...
CREATE TABLE [FDQA_Ascii_types] (
 ...
 [atBlob] [varbinary] (max) NULL ,
 [atMemo] [varchar] (max) NULL 
)
GO
...
CREATE TABLE [FDQA_DB_types] (
 ...
 [ftBlob] [varbinary] (max) NULL ,
 [ftMemo] [varchar] (max) NULL 
)
GO
