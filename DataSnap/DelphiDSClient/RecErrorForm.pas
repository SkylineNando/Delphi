...
type
  TReconcileErrorForm1 = class(TForm)
    UpdateType: TLabel;
...
constructor TReconcileErrorForm1.CreateForm(DataSet: TDataSet;
...
procedure TReconcileErrorForm1.InitDataFields;
var
  I: Integer;
  FD: PFieldData;
  V: Variant;
...
procedure TReconcileErrorForm1.InitUpdateData(HasCurValues: Boolean);
var
  FColCount: Integer;
begin
  FColCount := 1;
...
procedure TReconcileErrorForm1.InitReconcileActions;
...
procedure TReconcileErrorForm1.DisplayFieldValues(Sender: TObject);
var
  I: Integer;
  CurRow: Integer;
...
procedure TReconcileErrorForm1.SetFieldValues(DataSet: TDataSet);
var
  I: Integer;
begin
  for I := 0 to FDataFields.Count - 1 do
...
procedure TReconcileErrorForm1.AdjustColumnWidths;
var
  NewWidth, I: integer;
begin
  with UpdateData do
...
procedure TReconcileErrorForm1.FormCreate(Sender: TObject);
begin
...
procedure TReconcileErrorForm1.FormDestroy(Sender: TObject);
var
  I: Integer;
begin
...
procedure TReconcileErrorForm1.UpdateDataSetEditText(Sender: TObject; ACol,
...
procedure TReconcileErrorForm1.UpdateDataSelectCell(Sender: TObject; Col,
