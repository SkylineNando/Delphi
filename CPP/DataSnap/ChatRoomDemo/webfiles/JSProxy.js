...
function TChatRoomServerMethods(connectionInfo)
{
   ...
   * @return result - Type on server: Boolean
   */
  this.SendMessageW = function(Msg) {
    var returnObject = this.executor.executeMethod('SendMessageW', "GET", [Msg], arguments[1], true, arguments[2], arguments[3]);
    if (arguments[1] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.AS_Execute = function(ProviderName, CommandText, ParamReader, OwnerDataStream) {
    var returnObject = this.executor.executeMethod('"AS_Execute"', "POST", [ProviderName, CommandText, ParamReader, OwnerDataStream], arguments[4], true, arguments[5], arguments[6]);
    if (arguments[4] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
...
var JSProxyClassList = {
  ...
  "TChatRoomServerMethods": ["GetUserList","SendMessageW","SendMessageToUser","AS_GetProviderNames","AS_Execute"]
};
