...
void __fastcall TForm1::CheckBox1Change(TObject *Sender)
{
	...
	case TOSVersion::TPlatform::pfWindows:
		IBDatabase1->DatabaseName = "C:\\Users\\Public\\Documents\\RAD Studio\\12.0\\Samples\\Data\\employee.gdb";
		break;
...
void __fastcall TForm1::NavigatorBindSourceDB1Click(TObject *Sender, TNavigateButton Button)

{
	IBDataSet2->Active = false;
	IBDataSet2->ParamByName("Cust_No")->Value = IBDataSet1->FieldByName("CUST_NO")->Value;
	IBDataSet2->Active = true;
