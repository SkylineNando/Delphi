...
PTypeInfo UnicodeStringTypeInfo(void)
{
  PPTypeInfo Temp;

  Temp = GetPropInfo(__typeinfo(TVersionInfo), L"FileName")->PropType;
  assert(Temp != NULL);
...
PTypeInfo TDateTimeTypeInfo(void)
{
  ...
  Temp = GetPropInfo(__typeinfo(TVersionInfo), L"FileDate")->PropType;
  assert(Temp != NULL);
...
PTypeInfo intTypeInfo(void)
{
  ...
  Temp = GetPropInfo(__typeinfo(TVersionInfo), L"LanguageCharsetIndex")->PropType;
  assert(Temp != NULL);
...
namespace Versioninforegistration
{
  ...
  {
	const UnicodeString ComponentPaletteLocation = L"VersionInfo";
    //
	...
	//
	RegisterPropertyEditor( UnicodeStringTypeInfo(), __classid(TVersionInfo),
							L"FileName", __classid(TVersionInfoFileNameEditor) );
	...
	RegisterPropertyEditor( TDateTimeTypeInfo(), __classid(TVersionInfo),
							L"FileDate", __classid(TVersionInfoFileDateEditor) );
	...
	RegisterPropertyEditor( intTypeInfo(), __classid(TVersionInfo),
							L"LanguageCharsetIndex", __classid(TVersionInfoLanguageCharsetIndexEditor) );
