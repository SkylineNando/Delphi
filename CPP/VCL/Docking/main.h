...
__published:	// IDE-managed Components
  ...
  TPanel *BottomDockPanel;
	TDockTabSet *LeftDockTabSet;
	TDockTabSet *BottomDockTabSet;
  ...
  void __fastcall BottomDockPanelDockOver(TObject *Sender,
          TDragDockObject *Source, int X, int Y, TDragState State,
          bool &Accept);
	void __fastcall ToolBar1StartDock(TObject *Sender, TDragDockObject *&DragObject);
	void __fastcall LeftDockTabSetTabAdded(TObject *Sender);
	void __fastcall LeftDockTabSetTabRemoved(TObject *Sender);
	void __fastcall LeftDockTabSetGetSiteInfo(TObject *Sender, TControl *DockClient,
